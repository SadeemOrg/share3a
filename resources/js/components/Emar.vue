    ...
    <div class="mx-auto max-w-6xl sm:px-6 lg:px-8">
        <div class="flex flex-col items-center justify-center">
            <img src="https://i.postimg.cc/pdnRmpPj/image-1-removebg-preview-1.png" class="max-w-[420px] max-h-48"
                alt="My Photo" />
            <p class="font-bold mt-12 text-center text-3xl text-[#42542A]">
        ...
        <div class="flex flex-col items-start justify-start mt-8">
            <p class=" font-bold mt-12 text-center text-2xl text-[#42542A]">هذه الاستمارة مخصّصة للفئات التالية:</p>
            <div class="flex flex-col items-start justify-start text-xl font-medium text-[#42542A] mt-2 gap-y-1">
                ...
                <button type="button"
                    class="rounded-md bg-[#42542A] mt-3 w-60 h-12 px-2.5 py-1.5 font-bold text-lg text-white shadow-sm hover:bg-[#B0C277]">قم
                    بتعبئة الاستمارة</button>
            </div>
            <button type="button"
                class="rounded-md bg-[#B0C277] w-full mt-5 h-12 px-2.5 py-1.5 font-bold text-lg text-white shadow-sm hover:bg-[#42542A]">
                <div class="flex flex-row items-start mt-1 justify-center gap-x-2">
