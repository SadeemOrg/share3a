        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-4xl">
                <p class="Hebah-Font text-center text-[#E3BD2F] text-[25px] md:text-[40px] lg:text-7xl mb-10">
                    فرع كلية الشريعة في باقة الغربية
                </p>

                <div class="text-white text-center">
                    <p class="text-[25px] md:text-[40px] lg:text-[59px] bg-[#EBBD22] py-4 px-4 text-sh">
                        العلم الشرعي أصبح أقرب إليك
                        طريقك نحو التفوق الأكاديمي والمستقبل المهني يبدأ من هنا
                                            </p>
                    <p class="text-[23px] md:text-[35px] lg:text-[43px] bg-[#124A85] py-3 px-4">
                        التعليم في فرعنا الجديد في باقة الغربية يوفر عليك عناء التنقُّل.
                        تعلّم بالقرب من بيتك، وبأجواء ومستوى أكّاديمي مريح.
                                            </p>
                </div>
                @php
                ...
                <ul class="text-white features-list mt-10 pb-8 mb-8 border-b border-[#EBBD22] ">
                    <li class="mb-5">
                        <p class="text-[20px] md:text-[24px] lg:text-[27px] relative pr-10">
                            برنامج دبلوم الشريعة الإسلامية - الدراسة يوم السبت فقط!

                        </p>
                    </li>
                    <li class="mb-5">
                        <p class="text-[20px] md:text-[24px] lg:text-[27px] relative pr-10">
                            برنامج اللقب الأول وشهادة التدريس خلال 3 سنوات فقط ضمن البرنامج المباشر للَّقب الثاني.
                        </p>
                    </li>
                    <li class="mb-5">
                        <p class="text-[20px] md:text-[24px] lg:text-[27px] relative pr-10">
                            برامج تعليمية بإشراف نخبة من المحاضرين ذوي الخبرة، تضمن مستوى علميًّا متميّزًا وشهادة أكّاديمية معترف بها.

                        </p>
                    </li>
                    <li class="mb-5">
                        <p class="text-[20px] md:text-[24px] lg:text-[27px] relative pr-10">
                            نظام دفع مرن بالتقسيط، مصمَّم لتسهيل التعليم على الجميع دون أعباء مالية ثقيلة.
                        </p>
                    </li>
                    <li class="mb-5">
                        <p class="text-[20px] md:text-[24px] lg:text-[27px] relative pr-10">
                            لا حاجة لشهادة بجروت للطلّاب فوق جيل ال 30 عامًا، ممّا يمنح فرصة جديدة لكل من يرغب في تطوير مستقبله الأكاديمي.
                ...
                <div class="flex flex-row items-center justify-center my-4 text-white">
                    <p class="text-[16px] sm:text-[20px] md:text-[28px] lg:text-[35px] mb-10">
                        سجّل الآن في فرع باقة الغربية وابدأ رحلة التميّز مع كلية الشريعة!
                    </p>
                </div>
